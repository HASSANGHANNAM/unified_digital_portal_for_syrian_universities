...
class AuthController extends Controller
{
    ...
    public function verifyResetCodeWithoutToken(VerifyEmailRequestWithOutToken $request): JsonResponse
    {
        try {
            $data = $this->authServices->verifyResetCodeWithoutToken($request);
            return Response::success($data['data'], $data['message'], $data['code']);
        } catch (Throwable $th) {
            $message = $th->getMessage();
            return Response::Error([], $message);
